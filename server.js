...
const target = https://econom.lexum.sbs/sub/${encodeURIComponent(key)};
const subUrl = https://userrtmcore.com/api/sub/${encodeURIComponent(key)};
...
<div class="lines"></div>  <div class="wrap">  
  <div class="langs">  
    ...
    <div class="desc" id="mainDesc">Subscription linkiňizi aşakdaky programmalara bir basyş bilen goşuň.</div>  <div class="userBox">  
...
</div>  <div class="toast" id="toast">Göçürildi</div>  <script>  
